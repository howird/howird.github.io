...
$$
\overrightarrow w \cdot \overrightarrow u \ge c \implies
$$
...
- This classification is performed by computing the decision rule, see $(\text{5})$
...
- However, simple decision boundaries do not work if the classes are not linearly separable
    ...
    - I will be discussing a method to do so in this next section
